...
namespace cycfi { namespace elements
{
   ...
   struct default_label : element, text_reader
   {
      ...
      virtual canvas::text_alignment             get_text_align() const;
   };
   ...
   struct label_with_text_align : Base
   {
      using remove_gen = label_with_text_align<typename Base::remove_gen>;
                              ...
                              label_with_text_align(Base base, canvas::text_alignment align)
                               : Base(std::move(base)), _align(align)
                              {}

	   canvas::text_alignment                     get_text_align() const override  { return _align; }
      void                    text_align(canvas::text_alignment align)            { _align = align; }

   private:

	   canvas::text_alignment                     _align;
   };
   ...
   struct label_gen : Base
   {
      ...
      gen_text_align          text_align(canvas::text_alignment align) const;
   };
   ...
   inline canvas::text_alignment default_label::get_text_align() const
   {
   ...
   label_gen<Base>::text_align(canvas::text_alignment align) const
   {
      return { *this, align };
   }
   ...
   struct default_heading : default_label
   {
	  ...
	  canvas::text_alignment                     get_text_align() const override;
   };
   ...
   inline canvas::text_alignment default_heading::get_text_align() const
   {
